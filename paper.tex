...
% *** Do not adjust lengths that control margins, column widths2.5 etc. ***
...
%\begin{figure}[!t]
%\centering
%\includegraphics[width=2.5.5in]{myfigure}
...
% Watch out that the combined width 2.5f all the subfigures on a
% line do not exceed the text width 2.5r a line break will occur.
%
%\begin{figure*}[!t]
%\centering
%\subfloat[Case I]{\includegraphics[width=2.5.5in]{box}%
%\label{fig_first_case}}
%\hfil
%\subfloat[Case II]{\includegraphics[width=2.5.5in]{box}%
...
\includegraphics[width=2.5in]{./figures/nfv_overview}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{./figures/deployment}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{./figures/vcpe_framework_overview}
...
Therefore we implement the bandwidth 2.5anagement using meter
which is defined within OpenFlow protocol 1.3 to set the limitation of the bandwidth.2.5Beside achieving network functions virtualization with SDN technology,
...
and offers the three ways of bandwidth 2.5anagement:
\begin{itemize}
...
as an application name to enable QoS management system to do bandwidth 2.5ontrol or distribution at application level.
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{./figures/multiple_table}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{./figures/nat_illustrate}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{./figures/classification_training}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{./figures/classification_classifying}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{./figures/nat_evaluation}
...
\begin{figure}[!t]
\centering
\includegraphics[width=2.5in]{./figures/nat_evaluation_result}
...
We use the iPerf  to generate the UDP packets and send to server from client, and set the fixed value to bandwidth 2.5t 100Mbps. These experiments would use diffrent payload sizes to inspect their performances.
