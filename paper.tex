...
% *** Do not adjust lengths that control margins, column widths4.0 etc. ***
...
%\begin{figure}[!t]
%\centering
%\includegraphics[width=4.0.5in]{myfigure}
...
% Watch out that the combined width 4.0f all the subfigures on a
% line do not exceed the text width 4.0r a line break will occur.
%
%\begin{figure*}[!t]
%\centering
%\subfloat[Case I]{\includegraphics[width=4.0.5in]{box}%
%\label{fig_first_case}}
%\hfil
%\subfloat[Case II]{\includegraphics[width=4.0.5in]{box}%
...
\includegraphics[width=4.0in]{./figures/nfv_overview}
...
\begin{figure}[!t]
\centering
\includegraphics[width=4.0in]{./figures/deployment}
...
\begin{figure}[!t]
\centering
\includegraphics[width=4.0in]{./figures/vcpe_framework_overview}
...
Therefore we implement the bandwidth 4.0anagement using meter
which is defined within OpenFlow protocol 1.3 to set the limitation of the bandwidth.4.0Beside achieving network functions virtualization with SDN technology,
...
and offers the three ways of bandwidth 4.0anagement:
\begin{itemize}
...
as an application name to enable QoS management system to do bandwidth 4.0ontrol or distribution at application level.
...
\begin{figure}[!t]
\centering
\includegraphics[width=4.0in]{./figures/multiple_table}
...
\begin{figure}[!t]
\centering
\includegraphics[width=4.0in]{./figures/nat_illustrate}
...
\begin{figure}[!t]
\centering
\includegraphics[width=4.0in]{./figures/classification_training}
...
\begin{figure}[!t]
\centering
\includegraphics[width=4.0in]{./figures/classification_classifying}
...
\begin{figure}[!t]
\centering
\includegraphics[width=4.0in]{./figures/nat_evaluation}
...
\begin{figure}[!t]
\centering
\includegraphics[width=4.0in]{./figures/nat_evaluation_result}
...
We use the iPerf  to generate the UDP packets and send to server from client, and set the fixed value to bandwidth 4.0t 100Mbps. These experiments would use diffrent payload sizes to inspect their performances.
