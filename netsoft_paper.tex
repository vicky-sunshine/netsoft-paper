...
The architecture of the vCPE system is adapted from the NFV-MANO architectural framework in \cite{nfv2014-v111}, shown in Fig. \ref{fig:desc_vcpe_framework}, including of a Infrastructure Controller, Infrastructure Orchestrator, Cloud Database, VNF Controllers and VNF Orchestrator.
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{./figures/desc_vcpe_framework}
